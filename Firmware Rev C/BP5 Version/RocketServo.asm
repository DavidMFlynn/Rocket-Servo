;====================================================================================================
;
;   Filename:	RocketServo.asm (BP5 Hold version)
;   Date:	10/14/2024
;   File Version:	1.2b1
;
...
BP3Hold	EQU	1	;Hold at reverse value
;====================================================================================================
; To Do's
;
;====================================================================================================
...
;
; MS62 25kgcm servo turns CW as pulse width increases as viewed from the servo.
;
;====================================================================================================
;
;  Pin 1 VDD (+5V)		+5V
...
kMinPulseWidth	EQU	d'1000'	;500uS
